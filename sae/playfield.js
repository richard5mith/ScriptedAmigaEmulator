...
function SAEO_Playfield() {
	...
	*/
	...
	Object.defineProperty(this, "_saeState", {value: {
		get: function() { return {
			lores_factor,lores_shift,aga_mode,direct_rgb,res_shift,linedbl,linedbld,interlace_seen,
			can_use_lores,frame_res,frame_res_lace,resolution_count,lines_count,center_reset,
			need_genlock_data,init_genlock_data,dblpf_ms1,dblpf_ms2,dblpf_ms,dblpf_ind1,dblpf_ind2,
			dblpf_2nd1,dblpf_2nd2,dblpf_ind1_aga,dblpf_ind2_aga,sprite_offs,clxtab,gfxvidinfo,
			spritepixels_buffer,vi,spritepixels,spritepixels_pos,sprite_first_x,sprite_last_x,xcolors,
			xredcolors,xgreencolors,xbluecolors,xredcolor_s,xredcolor_b,xredcolor_m,xgreencolor_s,
			xgreencolor_b,xgreencolor_m,xbluecolor_s,xbluecolor_b,xbluecolor_m,colors_for_drawing,
			direct_colors_for_drawing,p_acolors,p_xcolors,pixdata,refresh_indicator_buffer,
			refresh_indicator_changed,refresh_indicator_changed_prev,refresh_indicator_height,spixels,
			spixstate,ham_linebuf,real_bplpt,all_ones,all_zeros,xlinebuffer,xlinebuffer_pos,
			amiga2aspect_line_map,native2amiga_line_map,max_drawn_amiga_line,row_map,
			row_map_color_burst_buffer,row_tmp,line_draw_func,linestate,line_data,min_diwstart,max_diwstop,
			visible_left_border,visible_right_border,visible_left_start,visible_right_stop,visible_top_start,
			visible_bottom_stop,hblank_left_start,hblank_right_stop,linetoscr_x_adjust_pixbytes,
			linetoscr_x_adjust_pixels,thisframe_y_adjust,thisframe_y_adjust_real,max_ypos_thisframe,
			min_ypos_for_screen,thisframe_first_drawn_line,thisframe_last_drawn_line,last_redraw_point,
			first_drawn_line,last_drawn_line,bplehb,bplham,bpldualpf,bpldualpfpri,bpldualpf2of,bplplanecnt,
			ecsshres,bplbypass,bplcolorburst,bplcolorburst_field,issprites,bplres,plf1pri,plf2pri,bplxor,
			bpland,bpldelay_sh,plf_sprite_mask,sbasecol,hposblank,specialmonitoron,
			ecs_genlock_features_active,ecs_genlock_features_mask,ecs_genlock_features_colorkey,
			inhibit_frame,framecnt,custom_frame_redraw_necessary,frame_redraw_necessary,
			picasso_redraw_necessary,warned_pfield_draw_line,gamma,blur_lf,blur_hf,gclow,gcloh,gclox,gcloy,
			gclorealh,stored_left_start,stored_top_start,stored_width,stored_height,dp_for_drawing,
			dip_for_drawing,playfield_start,playfield_end,real_playfield_start,real_playfield_end,
			sprite_playfield_start,may_require_hard_way,linetoscr_diw_start,linetoscr_diw_end,
			native_ddf_left,native_ddf_right,pixels_offset,src_pixel,unpainted,sprite_shdelay,
			pfield_do_linetoscr_normal,pfield_do_linetoscr_sprite,pfield_do_linetoscr_spriteonly,
			pfield_do_linetoscr_shdelay_normal,pfield_do_linetoscr_shdelay_sprite,ham_decode_pixel,
			ham_lastcolor,oldbufmem,oldheight,oldpitch,oldgenlock,drawing_color_matches,color_match_type,
			frame_res_cnt,autoswitch_old_resolution,hpos_offset,vpos,vpos_count,vpos_count_diff,lof_store,
			lof_current,lof_lastline,lof_prev_lastline,lol,next_lineno,prev_lineno,nextline_how,lof_changed,
			lof_changing,interlace_changed,lof_changed_previous_field,vposw_change,lof_lace,
			bplcon0_interlace_seen,scandoubled_line,vsync_rendered,genlockhtoggle,genlockvtoggle,
			graphicsbuffer_retry,scanlinecount,lof_togglecnt_lace,lof_togglecnt_nlace,vpos_previous,
			hpos_previous,vpos_lpen,hpos_lpen,lightpen_triggered,lightpen_x,lightpen_y,lightpen_cx,
			lightpen_cy,lightpen_active,lightpen_enabled,sprtaba,sprtabb,sprite_ab_merge,sprclx,clxmask,
			color_regs_genlock,cregs,maxhpos,maxhpos_short,maxvpos,maxvpos_nom,maxvpos_display,hsyncendpos,
			hsyncstartpos,maxvpos_total,minfirstline,firstblankedline,equ_vblank_endline,equ_vblank_toggle,
			vblank_hz,vblank_hz_stored,vblank_hz_nom,hblank_hz,vblank_hz_lof,vblank_hz_shf,vblank_hz_lace,
			vblank_hz_mult,vblank_hz_state,stored_chipset_refresh,doublescan,programmedmode,fmode_saved,
			fmode,beamcon0,new_beamcon0,varsync_changed,vtotal,htotal,maxvpos_stored,maxhpos_stored,hsstop,
			hbstrt,hbstop,vsstop,vbstrt,vbstop,hsstrt,vsstrt,hcenter,ciavsyncmode,diw_hstrt,diw_hstop,
			diw_hcounter,refptr,refptr_val,spr,plfstrt_sprite,sprite_ignoreverticaluntilnextline,sprite_0,
			sprite_0_width,sprite_0_height,sprite_0_doubled,sprite_0_colors,magic_sprite_mask,
			sprite_vblank_endline,sprctl,sprpos,sprdata,sprdatb,last_sprite_point,nr_armed,sprite_width,
			sprres,sprite_sprctlmask,sprite_buffer_res,bpl1dat_written,bpl1dat_written_at_least_once,
			bpldmawasactive,bpl1mod,bpl2mod,dbpl1mod,dbpl2mod,dbpl1mod_on,dbpl2mod_on,prevbpl,vj,vk,bplpt,
			bplptx,bitplane_line_crossing,current_colors,bplcon0,bplcon1,bplcon2,bplcon3,bplcon4,bplcon0d,
			bplcon0dd,bplcon0_res,bplcon0_planes,bplcon0_planes_limit,diwstrt,diwstop,diwhigh,
			diwhigh_written,ddfstrt,ddfstop,line_cyclebased,badmode,diw_change,bplcon1_fetch,
			hpos_is_zero_bplcon1_hack,plffirstline,plflastline,plffirstline_total,plflastline_total,
			autoscale_bordercolors,plfstrt,plfstop,sprite_minx,sprite_maxx,first_bpl_vpos,last_ddf_pix_hpos,
			last_decide_line_hpos,last_fetch_hpos,last_sprite_hpos,diwfirstword,diwlastword,last_hdiw,
			diwstate,hdiwstate,ddfstate,bpl_hstart,first_planes_vpos,last_planes_vpos,first_bplcon0,
			first_bplcon0_old,first_planes_vpos_old,last_planes_vpos_old,diwfirstword_total,
			diwlastword_total,ddffirstword_total,ddflastword_total,diwfirstword_total_old,
			diwlastword_total_old,ddffirstword_total_old,ddflastword_total_old,vertical_changed,
			horizontal_changed,firstword_bplcon1,clxdat,clxcon,clxcon2,clxcon_bpl_enable,clxcon_bpl_match,
			current_change_set,sprite_entries,color_changes,line_drawinfo,color_tables,line_decisions,
			next_sprite_entry,prev_next_sprite_entry,next_sprite_forced,curr_sprite_entries,
			prev_sprite_entries,curr_color_changes,prev_color_changes,curr_drawinfo,prev_drawinfo,
			curr_color_tables,prev_color_tables,next_color_change,next_color_entry,remembered_color_entry,
			color_src_match,color_dest_match,color_compare_result,thisline_changed,thisline_decision,
			fetch_cycle,fetch_modulo_cycle,aga_plf_passed_stop2,plf_start_hpos,plf_end_hpos,
			ddfstop_written_hpos,bitplane_off_delay,ocs_agnus_ddf_enable_toggle,bpl_dma_off_when_active,
			bitplane_maybe_start_hpos,ddfstop_matched,cpu_accurate,plf_state,plfr_state,fetch_state,
			warned_maybe_finish_last_fetch,fetchmode,fetchmode_size,fetchmode_mask,fetchmode_bytes,
			real_bitplane_number,fetchunit,fetchunit_mask,fetchstart,fetchstart_shift,fetchstart_mask,
			fm_maxplane,fm_maxplane_shift,cycle_diagram_table,cycle_diagram_free_cycles,
			cycle_diagram_total_cycles,curr_diagram,estimated_last_fetch_cycle,cycle_diagram_shift,outword,
			out_nbits,out_offs,todisplay,todisplay2,fetched,todisplay_fetched,todisplay_aga_hi,
			todisplay_aga_lo,todisplay2_aga_hi,todisplay2_aga_lo,fetched_aga_hi,fetched_aga_lo,toscr_res,
			toscr_res2p,toscr_nr_planes,toscr_nr_planes2,toscr_nr_planes_agnus,toscr_nr_planes_shifter,
			fetchwidth,toscr_delay,toscr_delay_adjusted,toscr_delay_sh,delay_cycles,delay_lastcycle,
			bplcon1_written,planesactiveatresetpoint,toscr_nbits,bpldmasetuphpos,bpldmasetuphpos_diff,
			bpldmasetupphase,cia_hsync,vhposr_oldhp,timehack_alive,
		}; },
		set: function(s) {
			lores_factor=s.lores_factor;
			lores_shift=s.lores_shift;
			aga_mode=s.aga_mode;
			direct_rgb=s.direct_rgb;
			res_shift=s.res_shift;
			linedbl=s.linedbl;
			linedbld=s.linedbld;
			interlace_seen=s.interlace_seen;
			can_use_lores=s.can_use_lores;
			frame_res=s.frame_res;
			frame_res_lace=s.frame_res_lace;
			resolution_count=s.resolution_count;
			lines_count=s.lines_count;
			center_reset=s.center_reset;
			need_genlock_data=s.need_genlock_data;
			init_genlock_data=s.init_genlock_data;
			dblpf_ms1=s.dblpf_ms1;
			dblpf_ms2=s.dblpf_ms2;
			dblpf_ms=s.dblpf_ms;
			dblpf_ind1=s.dblpf_ind1;
			dblpf_ind2=s.dblpf_ind2;
			dblpf_2nd1=s.dblpf_2nd1;
			dblpf_2nd2=s.dblpf_2nd2;
			dblpf_ind1_aga=s.dblpf_ind1_aga;
			dblpf_ind2_aga=s.dblpf_ind2_aga;
			sprite_offs=s.sprite_offs;
			clxtab=s.clxtab;
			gfxvidinfo=s.gfxvidinfo;
			spritepixels_buffer=s.spritepixels_buffer;
			vi=s.vi;
			spritepixels=s.spritepixels;
			spritepixels_pos=s.spritepixels_pos;
			sprite_first_x=s.sprite_first_x;
			sprite_last_x=s.sprite_last_x;
			xcolors=s.xcolors;
			xredcolors=s.xredcolors;
			xgreencolors=s.xgreencolors;
			xbluecolors=s.xbluecolors;
			xredcolor_s=s.xredcolor_s;
			xredcolor_b=s.xredcolor_b;
			xredcolor_m=s.xredcolor_m;
			xgreencolor_s=s.xgreencolor_s;
			xgreencolor_b=s.xgreencolor_b;
			xgreencolor_m=s.xgreencolor_m;
			xbluecolor_s=s.xbluecolor_s;
			xbluecolor_b=s.xbluecolor_b;
			xbluecolor_m=s.xbluecolor_m;
			colors_for_drawing=s.colors_for_drawing;
			direct_colors_for_drawing=s.direct_colors_for_drawing;
			p_acolors=s.p_acolors;
			p_xcolors=s.p_xcolors;
			pixdata=s.pixdata;
			refresh_indicator_buffer=s.refresh_indicator_buffer;
			refresh_indicator_changed=s.refresh_indicator_changed;
			refresh_indicator_changed_prev=s.refresh_indicator_changed_prev;
			refresh_indicator_height=s.refresh_indicator_height;
			spixels=s.spixels;
			spixstate=s.spixstate;
			ham_linebuf=s.ham_linebuf;
			real_bplpt=s.real_bplpt;
			all_ones=s.all_ones;
			all_zeros=s.all_zeros;
			xlinebuffer=s.xlinebuffer;
			xlinebuffer_pos=s.xlinebuffer_pos;
			amiga2aspect_line_map=s.amiga2aspect_line_map;
			native2amiga_line_map=s.native2amiga_line_map;
			max_drawn_amiga_line=s.max_drawn_amiga_line;
			row_map=s.row_map;
			row_map_color_burst_buffer=s.row_map_color_burst_buffer;
			row_tmp=s.row_tmp;
			line_draw_func=s.line_draw_func;
			linestate=s.linestate;
			line_data=s.line_data;
			min_diwstart=s.min_diwstart;
			max_diwstop=s.max_diwstop;
			visible_left_border=s.visible_left_border;
			visible_right_border=s.visible_right_border;
			visible_left_start=s.visible_left_start;
			visible_right_stop=s.visible_right_stop;
			visible_top_start=s.visible_top_start;
			visible_bottom_stop=s.visible_bottom_stop;
			hblank_left_start=s.hblank_left_start;
			hblank_right_stop=s.hblank_right_stop;
			linetoscr_x_adjust_pixbytes=s.linetoscr_x_adjust_pixbytes;
			linetoscr_x_adjust_pixels=s.linetoscr_x_adjust_pixels;
			thisframe_y_adjust=s.thisframe_y_adjust;
			thisframe_y_adjust_real=s.thisframe_y_adjust_real;
			max_ypos_thisframe=s.max_ypos_thisframe;
			min_ypos_for_screen=s.min_ypos_for_screen;
			thisframe_first_drawn_line=s.thisframe_first_drawn_line;
			thisframe_last_drawn_line=s.thisframe_last_drawn_line;
			last_redraw_point=s.last_redraw_point;
			first_drawn_line=s.first_drawn_line;
			last_drawn_line=s.last_drawn_line;
			bplehb=s.bplehb;
			bplham=s.bplham;
			bpldualpf=s.bpldualpf;
			bpldualpfpri=s.bpldualpfpri;
			bpldualpf2of=s.bpldualpf2of;
			bplplanecnt=s.bplplanecnt;
			ecsshres=s.ecsshres;
			bplbypass=s.bplbypass;
			bplcolorburst=s.bplcolorburst;
			bplcolorburst_field=s.bplcolorburst_field;
			issprites=s.issprites;
			bplres=s.bplres;
			plf1pri=s.plf1pri;
			plf2pri=s.plf2pri;
			bplxor=s.bplxor;
			bpland=s.bpland;
			bpldelay_sh=s.bpldelay_sh;
			plf_sprite_mask=s.plf_sprite_mask;
			sbasecol=s.sbasecol;
			hposblank=s.hposblank;
			specialmonitoron=s.specialmonitoron;
			ecs_genlock_features_active=s.ecs_genlock_features_active;
			ecs_genlock_features_mask=s.ecs_genlock_features_mask;
			ecs_genlock_features_colorkey=s.ecs_genlock_features_colorkey;
			inhibit_frame=s.inhibit_frame;
			framecnt=s.framecnt;
			custom_frame_redraw_necessary=s.custom_frame_redraw_necessary;
			frame_redraw_necessary=s.frame_redraw_necessary;
			picasso_redraw_necessary=s.picasso_redraw_necessary;
			warned_pfield_draw_line=s.warned_pfield_draw_line;
			gamma=s.gamma;
			blur_lf=s.blur_lf;
			blur_hf=s.blur_hf;
			gclow=s.gclow;
			...
			gclox=s.gclox;
			gcloy=s.gcloy;
			gclorealh=s.gclorealh;
			stored_left_start=s.stored_left_start;
			stored_top_start=s.stored_top_start;
			stored_width=s.stored_width;
			stored_height=s.stored_height;
			dp_for_drawing=s.dp_for_drawing;
			dip_for_drawing=s.dip_for_drawing;
			playfield_start=s.playfield_start;
			playfield_end=s.playfield_end;
			real_playfield_start=s.real_playfield_start;
			real_playfield_end=s.real_playfield_end;
			sprite_playfield_start=s.sprite_playfield_start;
			may_require_hard_way=s.may_require_hard_way;
			linetoscr_diw_start=s.linetoscr_diw_start;
			linetoscr_diw_end=s.linetoscr_diw_end;
			native_ddf_left=s.native_ddf_left;
			native_ddf_right=s.native_ddf_right;
			pixels_offset=s.pixels_offset;
			src_pixel=s.src_pixel;
			unpainted=s.unpainted;
			sprite_shdelay=s.sprite_shdelay;
			pfield_do_linetoscr_normal=s.pfield_do_linetoscr_normal;
			pfield_do_linetoscr_sprite=s.pfield_do_linetoscr_sprite;
			pfield_do_linetoscr_spriteonly=s.pfield_do_linetoscr_spriteonly;
			pfield_do_linetoscr_shdelay_normal=s.pfield_do_linetoscr_shdelay_normal;
			pfield_do_linetoscr_shdelay_sprite=s.pfield_do_linetoscr_shdelay_sprite;
			ham_decode_pixel=s.ham_decode_pixel;
			ham_lastcolor=s.ham_lastcolor;
			oldbufmem=s.oldbufmem;
			oldheight=s.oldheight;
			oldpitch=s.oldpitch;
			oldgenlock=s.oldgenlock;
			drawing_color_matches=s.drawing_color_matches;
			color_match_type=s.color_match_type;
			frame_res_cnt=s.frame_res_cnt;
			autoswitch_old_resolution=s.autoswitch_old_resolution;
			hpos_offset=s.hpos_offset;
			vpos=s.vpos;
			vpos_count=s.vpos_count;
			vpos_count_diff=s.vpos_count_diff;
			lof_store=s.lof_store;
			lof_current=s.lof_current;
			lof_lastline=s.lof_lastline;
			lof_prev_lastline=s.lof_prev_lastline;
			lol=s.lol;
			next_lineno=s.next_lineno;
			prev_lineno=s.prev_lineno;
			nextline_how=s.nextline_how;
			lof_changed=s.lof_changed;
			lof_changing=s.lof_changing;
			interlace_changed=s.interlace_changed;
			lof_changed_previous_field=s.lof_changed_previous_field;
			vposw_change=s.vposw_change;
			lof_lace=s.lof_lace;
			bplcon0_interlace_seen=s.bplcon0_interlace_seen;
			scandoubled_line=s.scandoubled_line;
			vsync_rendered=s.vsync_rendered;
			genlockhtoggle=s.genlockhtoggle;
			genlockvtoggle=s.genlockvtoggle;
			graphicsbuffer_retry=s.graphicsbuffer_retry;
			scanlinecount=s.scanlinecount;
			lof_togglecnt_lace=s.lof_togglecnt_lace;
			lof_togglecnt_nlace=s.lof_togglecnt_nlace;
			vpos_previous=s.vpos_previous;
			hpos_previous=s.hpos_previous;
			vpos_lpen=s.vpos_lpen;
			hpos_lpen=s.hpos_lpen;
			lightpen_triggered=s.lightpen_triggered;
			lightpen_x=s.lightpen_x;
			lightpen_y=s.lightpen_y;
			lightpen_cx=s.lightpen_cx;
			lightpen_cy=s.lightpen_cy;
			lightpen_active=s.lightpen_active;
			lightpen_enabled=s.lightpen_enabled;
			sprtaba=s.sprtaba;
			sprtabb=s.sprtabb;
			sprite_ab_merge=s.sprite_ab_merge;
			sprclx=s.sprclx;
			clxmask=s.clxmask;
			color_regs_genlock=s.color_regs_genlock;
			cregs=s.cregs;
			maxhpos=s.maxhpos;
			maxhpos_short=s.maxhpos_short;
			maxvpos=s.maxvpos;
			maxvpos_nom=s.maxvpos_nom;
			maxvpos_display=s.maxvpos_display;
			hsyncendpos=s.hsyncendpos;
			hsyncstartpos=s.hsyncstartpos;
			maxvpos_total=s.maxvpos_total;
			minfirstline=s.minfirstline;
			firstblankedline=s.firstblankedline;
			equ_vblank_endline=s.equ_vblank_endline;
			equ_vblank_toggle=s.equ_vblank_toggle;
			vblank_hz=s.vblank_hz;
			vblank_hz_stored=s.vblank_hz_stored;
			vblank_hz_nom=s.vblank_hz_nom;
			hblank_hz=s.hblank_hz;
			vblank_hz_lof=s.vblank_hz_lof;
			vblank_hz_shf=s.vblank_hz_shf;
			vblank_hz_lace=s.vblank_hz_lace;
			vblank_hz_mult=s.vblank_hz_mult;
			vblank_hz_state=s.vblank_hz_state;
			stored_chipset_refresh=s.stored_chipset_refresh;
			doublescan=s.doublescan;
			programmedmode=s.programmedmode;
			fmode_saved=s.fmode_saved;
			fmode=s.fmode;
			beamcon0=s.beamcon0;
			new_beamcon0=s.new_beamcon0;
			varsync_changed=s.varsync_changed;
			vtotal=s.vtotal;
			htotal=s.htotal;
			maxvpos_stored=s.maxvpos_stored;
			maxhpos_stored=s.maxhpos_stored;
			hsstop=s.hsstop;
			hbstrt=s.hbstrt;
			hbstop=s.hbstop;
			vsstop=s.vsstop;
			...
			vsstrt=s.vsstrt;
			hcenter=s.hcenter;
			ciavsyncmode=s.ciavsyncmode;
			diw_hstrt=s.diw_hstrt;
			diw_hstop=s.diw_hstop;
			diw_hcounter=s.diw_hcounter;
			refptr=s.refptr;
			refptr_val=s.refptr_val;
			spr=s.spr;
			plfstrt_sprite=s.plfstrt_sprite;
			sprite_ignoreverticaluntilnextline=s.sprite_ignoreverticaluntilnextline;
			sprite_0=s.sprite_0;
			sprite_0_width=s.sprite_0_width;
			sprite_0_height=s.sprite_0_height;
			sprite_0_doubled=s.sprite_0_doubled;
			sprite_0_colors=s.sprite_0_colors;
			magic_sprite_mask=s.magic_sprite_mask;
			sprite_vblank_endline=s.sprite_vblank_endline;
			sprctl=s.sprctl;
			sprpos=s.sprpos;
			sprdata=s.sprdata;
			sprdatb=s.sprdatb;
			last_sprite_point=s.last_sprite_point;
			nr_armed=s.nr_armed;
			sprite_width=s.sprite_width;
			sprres=s.sprres;
			sprite_sprctlmask=s.sprite_sprctlmask;
			sprite_buffer_res=s.sprite_buffer_res;
			bpl1dat_written=s.bpl1dat_written;
			bpl1dat_written_at_least_once=s.bpl1dat_written_at_least_once;
			bpldmawasactive=s.bpldmawasactive;
			bpl1mod=s.bpl1mod;
			bpl2mod=s.bpl2mod;
			dbpl1mod=s.dbpl1mod;
			dbpl2mod=s.dbpl2mod;
			dbpl1mod_on=s.dbpl1mod_on;
			dbpl2mod_on=s.dbpl2mod_on;
			prevbpl=s.prevbpl;
			vj=s.vj;
			vk=s.vk;
			bplpt=s.bplpt;
			bplptx=s.bplptx;
			bitplane_line_crossing=s.bitplane_line_crossing;
			...
			bplcon4=s.bplcon4;
			bplcon0d=s.bplcon0d;
			bplcon0dd=s.bplcon0dd;
			bplcon0_res=s.bplcon0_res;
			bplcon0_planes=s.bplcon0_planes;
			bplcon0_planes_limit=s.bplcon0_planes_limit;
			diwstrt=s.diwstrt;
			diwstop=s.diwstop;
			diwhigh=s.diwhigh;
			diwhigh_written=s.diwhigh_written;
			ddfstrt=s.ddfstrt;
			ddfstop=s.ddfstop;
			line_cyclebased=s.line_cyclebased;
			badmode=s.badmode;
			diw_change=s.diw_change;
			bplcon1_fetch=s.bplcon1_fetch;
			hpos_is_zero_bplcon1_hack=s.hpos_is_zero_bplcon1_hack;
			plffirstline=s.plffirstline;
			plflastline=s.plflastline;
			plffirstline_total=s.plffirstline_total;
			plflastline_total=s.plflastline_total;
			autoscale_bordercolors=s.autoscale_bordercolors;
			plfstrt=s.plfstrt;
			plfstop=s.plfstop;
			sprite_minx=s.sprite_minx;
			sprite_maxx=s.sprite_maxx;
			first_bpl_vpos=s.first_bpl_vpos;
			last_ddf_pix_hpos=s.last_ddf_pix_hpos;
			last_decide_line_hpos=s.last_decide_line_hpos;
			last_fetch_hpos=s.last_fetch_hpos;
			last_sprite_hpos=s.last_sprite_hpos;
			diwfirstword=s.diwfirstword;
			diwlastword=s.diwlastword;
			last_hdiw=s.last_hdiw;
			diwstate=s.diwstate;
			hdiwstate=s.hdiwstate;
			ddfstate=s.ddfstate;
			bpl_hstart=s.bpl_hstart;
			first_planes_vpos=s.first_planes_vpos;
			last_planes_vpos=s.last_planes_vpos;
			first_bplcon0=s.first_bplcon0;
			first_bplcon0_old=s.first_bplcon0_old;
			first_planes_vpos_old=s.first_planes_vpos_old;
			last_planes_vpos_old=s.last_planes_vpos_old;
			diwfirstword_total=s.diwfirstword_total;
			diwlastword_total=s.diwlastword_total;
			ddffirstword_total=s.ddffirstword_total;
			ddflastword_total=s.ddflastword_total;
			diwfirstword_total_old=s.diwfirstword_total_old;
			diwlastword_total_old=s.diwlastword_total_old;
			ddffirstword_total_old=s.ddffirstword_total_old;
			ddflastword_total_old=s.ddflastword_total_old;
			vertical_changed=s.vertical_changed;
			horizontal_changed=s.horizontal_changed;
			firstword_bplcon1=s.firstword_bplcon1;
			clxdat=s.clxdat;
			clxcon=s.clxcon;
			clxcon2=s.clxcon2;
			clxcon_bpl_enable=s.clxcon_bpl_enable;
			clxcon_bpl_match=s.clxcon_bpl_match;
			current_change_set=s.current_change_set;
			sprite_entries=s.sprite_entries;
			color_changes=s.color_changes;
			line_drawinfo=s.line_drawinfo;
			color_tables=s.color_tables;
			line_decisions=s.line_decisions;
			next_sprite_entry=s.next_sprite_entry;
			prev_next_sprite_entry=s.prev_next_sprite_entry;
			next_sprite_forced=s.next_sprite_forced;
			curr_sprite_entries=s.curr_sprite_entries;
			prev_sprite_entries=s.prev_sprite_entries;
			curr_color_changes=s.curr_color_changes;
			prev_color_changes=s.prev_color_changes;
			curr_drawinfo=s.curr_drawinfo;
			prev_drawinfo=s.prev_drawinfo;
			curr_color_tables=s.curr_color_tables;
			prev_color_tables=s.prev_color_tables;
			next_color_change=s.next_color_change;
			next_color_entry=s.next_color_entry;
			remembered_color_entry=s.remembered_color_entry;
			color_src_match=s.color_src_match;
			color_dest_match=s.color_dest_match;
			color_compare_result=s.color_compare_result;
			thisline_changed=s.thisline_changed;
			thisline_decision=s.thisline_decision;
			fetch_cycle=s.fetch_cycle;
			fetch_modulo_cycle=s.fetch_modulo_cycle;
			aga_plf_passed_stop2=s.aga_plf_passed_stop2;
			plf_start_hpos=s.plf_start_hpos;
			plf_end_hpos=s.plf_end_hpos;
			ddfstop_written_hpos=s.ddfstop_written_hpos;
			bitplane_off_delay=s.bitplane_off_delay;
			ocs_agnus_ddf_enable_toggle=s.ocs_agnus_ddf_enable_toggle;
			bpl_dma_off_when_active=s.bpl_dma_off_when_active;
			bitplane_maybe_start_hpos=s.bitplane_maybe_start_hpos;
			ddfstop_matched=s.ddfstop_matched;
			cpu_accurate=s.cpu_accurate;
			plf_state=s.plf_state;
			plfr_state=s.plfr_state;
			fetch_state=s.fetch_state;
			warned_maybe_finish_last_fetch=s.warned_maybe_finish_last_fetch;
			fetchmode=s.fetchmode;
			fetchmode_size=s.fetchmode_size;
			fetchmode_mask=s.fetchmode_mask;
			fetchmode_bytes=s.fetchmode_bytes;
			real_bitplane_number=s.real_bitplane_number;
			fetchunit=s.fetchunit;
			fetchunit_mask=s.fetchunit_mask;
			fetchstart=s.fetchstart;
			fetchstart_shift=s.fetchstart_shift;
			fetchstart_mask=s.fetchstart_mask;
			fm_maxplane=s.fm_maxplane;
			fm_maxplane_shift=s.fm_maxplane_shift;
			cycle_diagram_table=s.cycle_diagram_table;
			cycle_diagram_free_cycles=s.cycle_diagram_free_cycles;
			cycle_diagram_total_cycles=s.cycle_diagram_total_cycles;
			curr_diagram=s.curr_diagram;
			estimated_last_fetch_cycle=s.estimated_last_fetch_cycle;
			cycle_diagram_shift=s.cycle_diagram_shift;
			outword=s.outword;
			out_nbits=s.out_nbits;
			out_offs=s.out_offs;
			todisplay=s.todisplay;
			todisplay2=s.todisplay2;
			fetched=s.fetched;
			todisplay_fetched=s.todisplay_fetched;
			todisplay_aga_hi=s.todisplay_aga_hi;
			todisplay_aga_lo=s.todisplay_aga_lo;
			todisplay2_aga_hi=s.todisplay2_aga_hi;
			todisplay2_aga_lo=s.todisplay2_aga_lo;
			fetched_aga_hi=s.fetched_aga_hi;
			fetched_aga_lo=s.fetched_aga_lo;
			toscr_res=s.toscr_res;
			toscr_res2p=s.toscr_res2p;
			toscr_nr_planes=s.toscr_nr_planes;
			toscr_nr_planes2=s.toscr_nr_planes2;
			toscr_nr_planes_agnus=s.toscr_nr_planes_agnus;
			toscr_nr_planes_shifter=s.toscr_nr_planes_shifter;
			fetchwidth=s.fetchwidth;
			toscr_delay=s.toscr_delay;
			toscr_delay_adjusted=s.toscr_delay_adjusted;
			toscr_delay_sh=s.toscr_delay_sh;
			delay_cycles=s.delay_cycles;
			delay_lastcycle=s.delay_lastcycle;
			bplcon1_written=s.bplcon1_written;
			planesactiveatresetpoint=s.planesactiveatresetpoint;
			toscr_nbits=s.toscr_nbits;
			bpldmasetuphpos=s.bpldmasetuphpos;
			bpldmasetuphpos_diff=s.bpldmasetuphpos_diff;
			bpldmasetupphase=s.bpldmasetupphase;
			cia_hsync=s.cia_hsync;
			vhposr_oldhp=s.vhposr_oldhp;
			timehack_alive=s.timehack_alive;
		},
		functions: function() { return {
			PIXEL_XPOS,max_diwlastword,coord_hw_to_window_x,coord_window_to_hw_x,coord_diw_to_window_x,
			coord_window_to_diw_x,ce_is_borderblank,ce_is_bordersprite,ce_is_borderntrans,color_entry,
			CONVERT_RGB,getxcolor,color_reg_get,color_reg_set,color_reg_cmp,color_reg_cpy,color_change,
			cpy_color_change,cmp_color_change,sprite_entry,sps_union,decision,cpy_decision,draw_info,
			set_inhibit_frame,clear_inhibit_frame,toggle_inhibit_frame,lores_set,lores_reset,vidbuffer,
			vidbuf_description,spritepixelsbuf,pixdata_union,bits_in_mask,mask_shift,doMask,doColor,doAlpha,
			calc_gamma,calc_gammatable,lowbits,clearbuffer,reset_decision_table,count_frame,xshift,
			coord_native_to_amiga_x,coord_native_to_amiga_y,res_shift_from_window,res_shift_from_amiga,
			notice_screen_contents_lost,reset_custom_limits,set_blanking_limits,record_diw_line,
			get_shdelay_add,getbgc,set_res_shift,pfield_init_linetoscr,pfield_erase_hborder_sprites,
			pfield_erase_vborder_sprites,pfield_do_fill_line,fill_line2,fill_line_border,render_sprites,
			get_genlock_very_rare_and_complex_case,get_genlock_transparency,merge_2pixel16,merge_2pixel32,
			pfield_do_linetoscr,pfield_do_linetoscr_spr,pfield_do_nothing,pfield_do_linetoscr_normal_shdelay,
			pfield_do_linetoscr_sprite_shdelay,pfield_set_linetoscr,pfield_do_linetoscr_bordersprite_aga,
			dummy_worker,init_ham_decoding,decode_ham,gen_pfield_tables,draw_sprites_1,
			clear_bitplane_border_aga,weird_bitplane_fix,pfield_doline,init_row_map,init_aspect_maps,
			do_flush_screen,pfield_expand_dp_bplcon,isham,pfield_expand_dp_bplconx,adjust_drawing_colors,
			playfield_hard_way,do_color_changes,is_color_changes,pfield_draw_line,center_image,
			init_drawing_frame,putpixel,refresh_indicator_init,refresh_indicator_update,draw_frame2,
			setnativeposition,setspecialmonitorpos,init_hardware_frame,init_hardware_for_drawing_frame,
			finish_drawing_frame,hardware_line_completed,redraw_frame,vsync_handle_check,vsync_handle_redraw,
			hsync_record_line_state,gfxbuffer_reset,notice_resolution_seen,notice_interlace_seen,
			reset_drawing,gen_direct_drawing_table,drawing_init,isvsync_chipset,isvsync_rtg,isvsync,
			GET_RES_DENISE,GET_RES_AGNUS,GET_SPRITEWIDTH,GET_PLANES,nocustom,sprite,isecsshres,nodraw,
			doflickerfix,set_chipset_mode,update_mirrors,docols,notice_new_xcolors,remember_ctable,
			remember_ctable_for_border,get_equ_vblank_endline,HARD_DDF_LIMITS_DISABLED,HARD_DDF_STOP,
			decide_diw,GET_PLANES_LIMIT,reset_moddelays,add_modulo,add_modulos,finish_playfield_line,
			debug_cycle_diagram,create_cycle_diagram_table,estimate_last_fetch_cycle,record_color_change2,
			isehb,isocs7planes,islinetoggle,compute_toscr_delay,set_delay_lastcycle,setup_fmodes,
			maybe_setup_fmodes,maybe_check,bpldmainitdelay,clear_fetchbuffer,update_toscr_planes,
			maybe_first_bpl1dat,fetch_warn,fetch,toscr_3_ecs,toscr_3_aga,do_tosrc,do_delays_3_ecs,
			do_delays_fast_3_ecs,do_delays_3_aga,do_delays_fast_3_aga,do_delays,toscr_right_edge,toscr_1,
			toscr_fm0,toscr_fm1,toscr_fm2,toscr,toscr_0,flush_plane_data,flush_display,hack_shres_delay,
			update_denise_shifter_planes,update_denise,pfield_xlateptr,beginning_of_plane_block,
			long_fetch_16,long_fetch_32,aga_shift,aga_shift_n,long_fetch_64,do_long_fetch,finish_last_fetch,
			maybe_finish_last_fetch,finish_final_fetch,one_fetch_cycle,update_fetch_x,update_fetch,
			reset_bpl_vars,start_bpl_dma,cant_this_last_line,record_color_change,isbrdblank,issprbrd,
			record_register_change,expand_sprres,do_playfield_collisions,do_sprite_collisions,
			record_sprite_1,record_sprite,add_sprite,tospritexdiw,tospritexddf,fromspritexdiw,calcsprite,
			decide_sprites,sprites_differ,color_changes_differ,finish_decisions,reset_decisions,
			compute_vsynctime,dumpsync,current_maxvpos,get_chipset_refresh,changed_chipset_refresh,
			compute_framesync,init_hz,init_hz_vposw,init_hz_normal,hsync_scandoubler,vsync_handler_pre,
			vsync_handler_post,set_hpos,hsync_handler_pre,is_last_line,hsync_handler_post,is_custom_vsync,
			calcdiw,islightpentriggered,issyncstopped,GETVPOS,GETHPOS,hsyncdelay,varsync,BPLCON0_Denise,
			castWord,spr_arm,sprstartstop,SPRxCTLPOS,SPRxCTL_1,SPRxPOS_1,SPRxDATA_1,SPRxDATB_1,
			checkautoscalecol0,cursorsprite,sprite_fetch,sprite_fetch2,do_sprites_1,do_sprites,setup_sprites,
			reset_sprites,mousehack_helper_old,timehack_helper,reset_all_systems,shsprite,
			linetoscr_16_sh_func,linetoscr_16_sh_spr,linetoscr_16_sh,linetoscr_32_sh_func,
			linetoscr_32_sh_spr,linetoscr_32_sh,linetoscr_32_shrink1_sh_func,linetoscr_32_shrink1_sh_spr,
			linetoscr_32_shrink1_sh,linetoscr_32_shrink1f_sh_func,linetoscr_32_shrink1f_sh_spr,
			linetoscr_32_shrink1f_sh,linetoscr_16_shrink1_sh_func,linetoscr_16_shrink1_sh_spr,
			linetoscr_16_shrink1_sh,linetoscr_16_shrink1f_sh_func,linetoscr_16_shrink1f_sh_spr,
			linetoscr_16_shrink1f_sh,linetoscr_32_shrink2_sh_func,linetoscr_32_shrink2_sh_spr,
			linetoscr_32_shrink2_sh,linetoscr_32_shrink2f_sh_func,linetoscr_32_shrink2f_sh_spr,
			linetoscr_32_shrink2f_sh,linetoscr_16_shrink2_sh_func,linetoscr_16_shrink2_sh_spr,
			linetoscr_16_shrink2_sh,linetoscr_16_shrink2f_sh_func,linetoscr_16_shrink2f_sh_spr,
			linetoscr_16_shrink2f_sh,linetoscr_16,linetoscr_16_stretch1,linetoscr_16_stretch2,
			linetoscr_16_shrink1,linetoscr_16_shrink1f,linetoscr_16_shrink2,linetoscr_16_shrink2f,
			linetoscr_16_spr,linetoscr_16_stretch1_spr,linetoscr_16_stretch2_spr,linetoscr_16_shrink1_spr,
			linetoscr_16_shrink1f_spr,linetoscr_16_shrink2_spr,linetoscr_16_shrink2f_spr,
			linetoscr_16_aga_spronly,linetoscr_16_stretch1_aga_spronly,linetoscr_16_stretch2_aga_spronly,
			linetoscr_16_shrink1_aga_spronly,linetoscr_16_shrink1f_aga_spronly,
			linetoscr_16_shrink2_aga_spronly,linetoscr_16_shrink2f_aga_spronly,linetoscr_16_aga,
			linetoscr_16_stretch1_aga,linetoscr_16_stretch2_aga,linetoscr_16_shrink1_aga,
			linetoscr_16_shrink1f_aga,linetoscr_16_shrink2_aga,linetoscr_16_shrink2f_aga,
			linetoscr_16_aga_spr,linetoscr_16_stretch1_aga_spr,linetoscr_16_stretch2_aga_spr,
			linetoscr_16_shrink1_aga_spr,linetoscr_16_shrink1f_aga_spr,linetoscr_16_shrink2_aga_spr,
			linetoscr_16_shrink2f_aga_spr,linetoscr_32,linetoscr_32_stretch1,linetoscr_32_stretch2,
			linetoscr_32_shrink1,linetoscr_32_shrink1f,linetoscr_32_shrink2,linetoscr_32_shrink2f,
			linetoscr_32_spr,linetoscr_32_stretch1_spr,linetoscr_32_stretch2_spr,linetoscr_32_shrink1_spr,
			linetoscr_32_shrink1f_spr,linetoscr_32_shrink2_spr,linetoscr_32_shrink2f_spr,
			linetoscr_32_aga_spronly,linetoscr_32_stretch1_aga_spronly,linetoscr_32_stretch2_aga_spronly,
			linetoscr_32_shrink1_aga_spronly,linetoscr_32_shrink1f_aga_spronly,
			linetoscr_32_shrink2_aga_spronly,linetoscr_32_shrink2f_aga_spronly,linetoscr_32_aga,
			linetoscr_32_stretch1_aga,linetoscr_32_stretch2_aga,linetoscr_32_shrink1_aga,
			linetoscr_32_shrink1f_aga,linetoscr_32_shrink2_aga,linetoscr_32_shrink2f_aga,
			linetoscr_32_aga_spr,linetoscr_32_stretch1_aga_spr,linetoscr_32_stretch2_aga_spr,
			linetoscr_32_shrink1_aga_spr,linetoscr_32_shrink1f_aga_spr,linetoscr_32_shrink2_aga_spr,
			linetoscr_32_shrink2f_aga_spr,
		}; },
		constants: function() { return {
			SMART_UPDATE,SPEEDUP,MAX_SPRITES,MAX_PLANES,MAX_WORDS_PER_LINE,MAXHPOS,MAXVPOS,RES_MAX,VRES_QUAD,
			VRES_MAX,DIW_DDF_OFFSET,HBLANK_OFFSET,DISPLAY_LEFT_SHIFT,DIW_WAITING_START,DIW_WAITING_STOP,
			min_diwlastword,CE_BORDERBLANK,CE_BORDERNTRANS,CE_BORDERSPRITE,CE_SHRES_DELAY,
			COLOR_CHANGE_BRDBLANK,COLOR_CHANGE_SHRES_DELAY,MAX_PIXELS_PER_LINE,MAX_SPR_PIXELS,MAX_REG_CHANGE,
			nln_normal,nln_doubled,nln_upper,nln_lower,nln_nblack,nln_upper_black,nln_lower_black,
			nln_upper_black_always,nln_lower_black_always,IHF_SCROLLLOCK,IHF_QUIT_PROGRAM,IHF_PICASSO,
			BG_COLOR_DEBUG,AUTO_LORES_FRAMES,dblpfofs,LINE_UNDECIDED,LINE_DECIDED,LINE_DECIDED_DOUBLE,
			LINE_AS_PREVIOUS,LINE_BLACK,LINE_REMEMBERED_AS_BLACK,LINE_DONE,LINE_DONE_AS_PREVIOUS,
			LINE_REMEMBERED_AS_PREVIOUS,LINESTATE_SIZE,MAX_WORDS_PER_LINE_FULL,MAX_STOP,NO_BLOCK,
			MIN_DISPLAY_W,MIN_DISPLAY_H,MAX_DISPLAY_W,MAX_DISPLAY_H,PLANE_OFFS1,PLANE_OFFS2,PLANE_OFFS3,
			PLANE_OFFS4,PLANE_OFFS5,PLANE_OFFS6,PLANE_OFFS7,color_match_acolors,color_match_full,dh_buf,
			dh_line,dh_emerg,refresh_indicator_colors,AUTOSCALE_SPRITES,MAXHPOS_ROWS,MAXVPOS_LINES_ECS,
			MAXVPOS_LINES_OCS,HPOS_SHIFT,MAXHPOS_PAL,MAXHPOS_NTSC,MAXVPOS_PAL,MAXVPOS_NTSC,
			VBLANK_ENDLINE_PAL,VBLANK_ENDLINE_NTSC,VBLANK_SPRITE_PAL,VBLANK_SPRITE_NTSC,VBLANK_HZ_PAL,
			VBLANK_HZ_NTSC,VSYNC_ENDLINE_PAL,VSYNC_ENDLINE_NTSC,EQU_ENDLINE_PAL,EQU_ENDLINE_NTSC,
			LOF_TOGGLES_NEEDED,SPR0_HPOS,COLOR_TABLE_SIZE,plf_idle,plf_passed_enable,plf_passed_start,
			plf_active,plf_wait,plf_passed_stop,plf_passed_stop_act,plf_passed_stop2,plf_end,plfr_idle,
			plfr_active,plfr_end,plfr_finished,fetch_not_started,fetch_started_first,fetch_started,
			fetch_was_plane0,DDF_OFFSET,HARD_DDF_START_REAL,fetchunits,fetchstarts,fm_maxplanes,
			cycle_sequences,PLANE_RESET_HPOS,
		}; }
	}});
