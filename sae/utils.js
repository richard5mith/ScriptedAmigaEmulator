...
function SAEF_ZFile_fopen_file(file) {
	if (file.size) {
		...
		if (magic == 0x504B0304 || magic == 0x04034B50 || magic == 0x504B0506 || (l.data[0] == 0x1f && l.data[1] == 0x8b) || (l.data[2] == 45 && l.data[3] == 108 && l.data[6] == 45))
			SAEF_fatal(SAEE_Config_Compressed, "Prepare compressed media with SAEF_Archive.open() before passing it to the emulator.");
